...
import './test.css'
import HorizontalWidget from '../../common/header/htab/HorizontalWidget'
function Test() {
    return (
        <div>
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus, quas esse deserunt ad in maiores repudiandae accusamus nisi ex impedit aperiam eum fuga sint provident saepe porro maxime neque et!</p>
        </div>
    )
}
